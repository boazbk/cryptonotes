...
\begin{pause} \label[pause]{Please-re-read-the-previo}
...
Things are better if we assume synchrony (i.e., a global clock and some
bounds on the latency of messages) as well as that a majority or
...
\begin{pause} \label[pause]{Stop-here-and-try-to-thin}
...
\begin{pause} \label[pause]{Indeed-it-is-an-excellent}
...
We can now specify the ``proof of work'' protocol for Bitcoin. Given
...
\begin{proof} \label[proof]{Let-us-think-of-H-in-the-}
...
Functions}\label{Practical-Constructions-o}
...
\begin{proof} \label[proof]{The-intuition-behind-the-}
...
\subsection{The NSA and Hash Functions}\label{The-NSA-and-Hash-Function}
