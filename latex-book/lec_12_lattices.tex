\chapter{Lattice based cryptography}\label{12-Lattice-based-cryptogr}
...
\subsection{Quick linear algebra recap}\label{12-Quick-linear-algebra-r}
...
elimination}\label{12-A-world-without-Gaussi}
...
\begin{pause} \label[pause]{12-If-you-have-a-CPA-secu}
...
\begin{quote} \label[quote]{12-Scheme-LwoE-ENC-Public}
...
\begin{pause} \label[pause]{12-Please-stop-here-and-m}
...
\section{Security in the real world.}\label{12-Security-in-the-real-w}
...
\begin{quote} \label[quote]{12-Conjecture-Learning-wi}
...
taken over \(A\) a random \(m\times n\) matrix in \(\Z_q\), \(x\) a
...
\section{Search to decision}\label{12-Search-to-decision}
...
\begin{proof} \label[proof]{12-Suppose-that-we-had-a-}
...
\begin{quote} \label[quote]{12-LWE-based-encryption-L}
...
\begin{pause} \label[pause]{12-The-scheme-LWEENC-is-a}
...
\begin{proof} \label[proof]{12-langle-wtop-Ax-rangle-}
...
\begin{pause} \label[pause]{12-You-should-stop-here-a}
...
\begin{proof}[Proof of \cref{LWEENClem}] \label[proof]{12-Define-D-to-be-the-dis}
...
\begin{pause} \label[pause]{12-The-proof-of-crefLWEEN}
...
\section{But what are lattices?}\label{12-But-what-are-lattices}
