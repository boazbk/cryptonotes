...
Security.}\label{16-Ideal-vsReal-Model-Sec}
...
computation}\label{16-Formally-defining-secu}
...
definition}\label{16-First-attempt-a-slight}
...
\subsection{Allowing for aborts}\label{16-Allowing-for-aborts}
...
\begin{pause} \label[pause]{16-It-is-an-excellent-ide}
...
\subsection{Some comments:}\label{16-Some-comments}
...
bitcoin}\label{16-Example-Second-price-a}
...
cryptography}\label{16-Another-example-distri}
...
theorem:}\label{16-Proving-the-fundamenta}
...
\begin{pause} \label[pause]{16-Really-please-stop-and}
...
\begin{pause} \label[pause]{16-Did-you-stop-and-think}
...
strategies:}\label{16-Handling-probabilistic}
