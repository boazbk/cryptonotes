...
\begin{solution} \label[solution]{Yes-if-multiplication-and}
...
\begin{solution} \label[solution]{-and--Recall-that-a-gener}
...
\begin{solution} \label[solution]{The-orders-of--are------r}
...
\begin{solution} \label[solution]{Suppose-that-a-in-mathbbG}
...
\begin{solution} \label[solution]{Suppose-that-ca--c-for-al}
...
\begin{solution} \label[solution]{To-be-a-subgroup-we-need-}
...
\begin{solution} \label[solution]{Suppose-that-we-recieve-s}
