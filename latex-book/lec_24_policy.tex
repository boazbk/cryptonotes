...
cryptography}\label{Ethical-moral-and-policy-dimen}
...
\section{Reading prior to lecture:}\label{Reading-prior-to-lecture}
...
\subsection{FBI vs Apple case}\label{FBI-vs-Apple-case}
...
break-in}\label{Juniper-backdoor-case-and-the-}
