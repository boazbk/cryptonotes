...
crypto}\label{10-Concrete-candidates-fo}
...
\section{Some number theory.}\label{10-Some-number-theory}
...
\subsection{Primaliy testing}\label{10-Primaliy-testing}
...
\begin{proof} \label[proof]{10-The-algorithm-is-very-}
...
\subsection{Fields}\label{10-Fields}
...
\subsection{Chinese remainder theorem}\label{10-Chinese-remainder-theo}
...
\begin{proof} \label[proof]{10-varphi-simply-maps-xin}
...
\begin{proof} \label[proof]{10-Suppose-that-there-is-}
...
functions}\label{10-The-RSA-and-Rabin-func}
...
\begin{proof} \label[proof]{10-Suppose-that-ensuremat}
...
permutations}\label{10-Abstraction-trapdoor-p}
...
permutations}\label{10-Public-key-encryption-}
...
\begin{pause} \label[pause]{10-Please-verify-that-you}
...
\begin{proof} \label[proof]{10-Suppose-towards-the-sa}
...
\begin{pause} \label[pause]{10-This-proof-of-crefTDPp}
...
permutations}\label{10-Digital-signatures-fro}
...
\begin{pause} \label[pause]{10-Once-again-this-proof-}
...
oracles}\label{10-Hardcore-bits-and-secu}
...
\begin{pause} \label[pause]{10-Please-stop-to-verify-}
...
\begin{proof} \label[proof]{10-The-result-follows-fro}
...
\begin{pause} \label[pause]{10-It-is-important-that-y}
