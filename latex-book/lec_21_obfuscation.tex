...
\section{The software patch problem}\label{The-software-patch-proble}
...
\section{Applications of obfuscation}\label{Applications-of-obfuscati}
...
\section{Impossibility of obfuscation}\label{Impossibility-of-obfuscat}
...
obfuscation}\label{Proof-of-impossibility-of}
...
\begin{proof} \label[proof]{Let-GEDensuremathmathitEV}
...
\begin{pause} \label[pause]{This-proof-is-simple-but-}
...
obfuscation}\label{Indistinguishability-obfu}
