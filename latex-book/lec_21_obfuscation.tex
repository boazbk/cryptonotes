\chapter{Software Obfuscation}\label{22-Software-Obfuscation}
...
\section{Witness encryption}\label{22-Witness-encryption}
...
\section{Deniable encryption}\label{22-Deniable-encryption}
...
\section{Functional encryption}\label{22-Functional-encryption}
...
\section{The software patch problem}\label{22-The-software-patch-pro}
...
\section{Software obfuscation}\label{22-Software-obfuscation}
...
\section{Applications of obfuscation}\label{22-Applications-of-obfusc}
...
\section{Impossibility of obfuscation}\label{22-Impossibility-of-obfus}
...
obfuscation}\label{22-Proof-of-impossibility}
...
\begin{proof} \label[proof]{22-Suppose-towards-a-cont}
...
\begin{proof} \label[proof]{22-Let-GEDensuremathmathi}
...
\begin{pause} \label[pause]{22-This-proof-is-simple-b}
...
obfuscation}\label{22-Indistinguishability-o}
