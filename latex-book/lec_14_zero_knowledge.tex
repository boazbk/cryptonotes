\chapter{Zero knowledge proofs}\label{13-Zero-knowledge-proofs}
...
\begin{pause} \label[pause]{13-Please-stop-and-make-s}
...
\section{Defining zero knowledge}\label{13-Defining-zero-knowledg}
...
\begin{proof} \label[proof]{13-Let-V-be-an-arbitrary-}
...
\begin{proof} \label[proof]{13-We-need-to-prove-compl}
