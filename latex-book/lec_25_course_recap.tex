\chapter{Course recap}\label{Course-recap}
...
\item
  ...
  one tool that if it existed would imply all the others. We saw that
...
\section{Some things we did not
cover}\label{Some-things-we-did-not-cover}
