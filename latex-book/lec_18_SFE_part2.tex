\chapter{Multiparty secure computation: Construction using Fully
Homomorphic Encryption}\label{Multiparty-secure-computa}
...
homomorphic encryption}\label{Constructing--party-hones}
...
\begin{pause} \label[pause]{Please-stop-here-and-try-}
...
encryption}\label{Achieving-circuit-privacy}
...
\begin{proof} \label[proof]{This-has-a-simple-proof-b}
...
\begin{pause} \label[pause]{We-omit-the-proof-of-cref}
...
computation protocol}\label{Bottom-line-A-two-party-h}
