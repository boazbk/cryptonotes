...
homomorphic encryption}\label{19-Constructing--party-ho}
...
\begin{pause} \label[pause]{19-At-this-point-you-migh}
...
\begin{pause} \label[pause]{19-Please-stop-here-and-t}
...
encryption}\label{19-Achieving-circuit-priv}
...
\begin{proof} \label[proof]{19-This-has-a-simple-proo}
...
\begin{pause} \label[pause]{19-We-omit-the-proof-of-c}
...
protocol}\label{19-Bottom-line-A-two-part}
...
\begin{proofidea} \label[proofidea]{19-We-do-not-include-the-}
...
\section{Beyond two parties}\label{19-Beyond-two-parties}
...
\begin{proof} \label[proof]{19-To-be-completed}
