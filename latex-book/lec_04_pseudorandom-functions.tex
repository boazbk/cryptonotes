...
\(i \in \{0,\ldots,2^{|s|}-1\}\) outputs \(f_s(i)\) is a PRF.
...
assume that it has any output size that is convenient for us.
...
\(V_k(m,\tau)\) to output \(1\) iff \(F_k(m)=\tau\). Suppose towards the
