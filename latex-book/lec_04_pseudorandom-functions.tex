...
\begin{pause} \label[pause]{Now-would-be-a-fantastic-time-}
...
etc.)}\label{One-time-passwords-egGoogle-Au}
...
\begin{pause} \label[pause]{This-would-be-a-good-time-to-s}
...
problem?}\label{How-do-pseudorandom-functions-}
...
\begin{proof} \label[proof]{This-proof-as-so-many-others-i}
...
\begin{proof} \label[proof]{Let-Fcdotcdot-be-a-secure-pseu}
...
PRFs}\label{Input-length-extension-for-MAC}
