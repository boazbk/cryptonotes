...
II}\label{Quantum-computing-and-cryptogr}
...
log}\label{From-order-finding-to-factorin}
...
Algorithm}\label{Finding-periods-of-a-function-}
...
\begin{proof} \label[proof]{Let-ensuremathmathitHAD-be-the}
...
\section{From Simon to Shor}\label{From-Simon-to-Shor}
...
\(\Z_m\)}\label{The-Fourier-transform-over-Zm}
...
\(\Z_m\)}\label{Quantum-Fourier-Transform-over}
...
Algorithm.}\label{Shors-Order-Finding-Algorithm}
...
\(r|m\)}\label{Analysis-the-case-that-rm}
