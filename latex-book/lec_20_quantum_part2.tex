...
II}\label{19-Quantum-computing-and-}
...
log}\label{19-From-order-finding-to-}
...
Algorithm}\label{19-Finding-periods-of-a-f}
...
\begin{proof} \label[proof]{19-Let-ensuremathmathitHA}
...
\section{From Simon to Shor}\label{19-From-Simon-to-Shor}
...
\(\Z_m\)}\label{19-The-Fourier-transform-}
...
\subsubsection{Fast Fourier Transform.}\label{19-Fast-Fourier-Transform}
...
\(\Z_m\)}\label{19-Quantum-Fourier-Transf}
...
Algorithm.}\label{19-Shors-Order-Finding-Al}
...
\(r|m\)}\label{19-Analysis-the-case-that}
...
\subsubsection{The general case}\label{19-The-general-case}
