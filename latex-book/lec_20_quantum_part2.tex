...
II}\label{Quantum-computing-and-cry}
...
log}\label{From-order-finding-to-fac}
...
Algorithm}\label{Finding-periods-of-a-func}
...
\begin{proof} \label[proof]{Let-ensuremathmathitHAD-b}
...
\(\Z_m\)}\label{The-Fourier-transform-ove}
...
\(\Z_m\)}\label{Quantum-Fourier-Transform}
...
Algorithm.}\label{Shors-Order-Finding-Algor}
