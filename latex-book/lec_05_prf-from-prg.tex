...
generators}\label{Pseudorandom-functions-from-ps}
...
\begin{proof} \label[proof]{If-the-PRG-Conjecture-is-true-}
...
security}\label{Securely-encrypting-many-messa}
...
\begin{pause} \label[pause]{Try-to-think-what-kind-of-secu}
...
\begin{proof} \label[proof]{The-proof-is-very-simple-Eve-w}
...
\begin{proof} \label[proof]{I-leave-to-you-to-verify-that-}
...
ciphers}\label{Pseudorandom-permutations--blo}
...
\begin{pause} \label[pause]{At-first-look-crefPRPdef-might}
...
\begin{proof} \label[proof]{creffeistelfig-illustrates-the}
...
Encryption}\label{Optional-Aside-Broadcast-Encry}
