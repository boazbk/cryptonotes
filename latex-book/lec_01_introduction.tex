...
\begin{remark}[Notation] \label[remark]{notation}
...
for the same parameter.) We use \(n\) to correspond with the standard
algorithmic notation for input length (as in \(O(n)\) time algorithms).
